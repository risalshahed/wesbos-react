...
class App extends React.Component {
  ...
  state = {
    fishes: {}, // a const variable from sample-fishes.js file
    order: {}
  };
    ...
    return(
      <>
        <div className='catch-of-the-day'>
          ...
          {/* pass everything from state into order with Object Spread */}
          {/* <Order {...this.state} /> */}
          {/* but, eivabe state er shob data pass kora BAD practice; onk smy dekha jabe amra pass krte chai na emn data o pass hye jabe! */}
          <Inventory
